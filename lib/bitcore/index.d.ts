...
export class Transaction {
  ...
  shuffleOutputs(): this
  sortOutputs(
    sortingFunction: (outputs: Transaction.Output[]) => Transaction.Output[],
  ): this
  sortInputs(
...
export class Address {
  ...
  constructor(
    data: Buffer | Uint8Array | string | object | any,
    network?: string | Networks.Network,
    type?: string,
  )
...
export class Unit {
  ...
  static fromSatoshis(amount: bigint): Unit

  constructor(amount: number | bigint, unitPreference: string)
